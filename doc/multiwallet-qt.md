...
Only requiring some minor changes is growth.cpp.
...
Changes to growth.cpp
----------------------
growth.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
