...
pkgdatadir = $(datadir)/growthcore
pkgincludedir = $(includedir)/growthcore
pkglibdir = $(libdir)/growthcore
pkglibexecdir = $(libexecdir)/growthcore
...
CONFIG_HEADER = $(top_builddir)/src/config/growth-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/growth-config.h.in \
...
ACLOCAL = ${SHELL} /home/travis/growthcoin-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/travis/growthcoin-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/travis/growthcoin-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/travis/growthcoin-master/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = growth-cli
BITCOIN_DAEMON_NAME = growthd
BITCOIN_GUI_NAME = growth-qt
BITCOIN_TX_NAME = growth-tx
...
COPYRIGHT_HOLDERS_FINAL = The Growth Coin developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Growth Coin
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/travis/growthcoin-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = growthcore
PACKAGE_BUGREPORT = https://github.com/growthcoin/growthcoin/issues
PACKAGE_NAME = Growth Coin
PACKAGE_STRING = Growth Coin 0.6.0
PACKAGE_TARNAME = growthcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/travis/growthcoin-master
abs_srcdir = /home/travis/growthcoin-master
abs_top_builddir = /home/travis/growthcoin-master
abs_top_srcdir = /home/travis/growthcoin-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/travis/growthcoin-master/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/growthd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/growth-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/growth-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Growth-Qt.app
OSX_DMG = Growth-Core.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Growth-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/growth-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/growth-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/growth-config.h
$(top_srcdir)/src/config/growth-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/growth-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Growth-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Growth-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Growth-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Growth-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
