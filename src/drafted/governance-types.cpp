...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GrowthNetwork") type = GrowthNetwork;
    if(strType == "GrowthNetworkVariable") type = GrowthNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GrowthNetwork) s = "GrowthNetwork";
    if(type == GrowthNetworkVariable) s = "GrowthNetworkVariable";
