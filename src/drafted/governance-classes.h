 ...
 *
 *   // network
 *   CGrowthNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.growthcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGrowthNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GrowthNetwork
// //   -- signature requirements : Key1(User)
// class CGrowthNetworkVariable : public CGovernanceObject
// {
// private:
