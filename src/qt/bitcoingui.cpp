    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Growth Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Growth address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and growth: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Growth Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Growth Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Growth Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Growth addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Growth addresses"));
    ...
    openAction->setStatusTip(tr("Open a growth: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Growth Coin help message to get a list with possible Growth Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Growth Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Growth network", "", count));
}
...
{
    QString strTitle = tr("Growth Coin"); // default title
