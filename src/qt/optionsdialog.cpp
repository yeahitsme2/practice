    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GRW-light"), QVariant("light"));
    ui->theme->addItem(QString("GRW-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GRW-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GRW-traditional"), QVariant("trad"));
