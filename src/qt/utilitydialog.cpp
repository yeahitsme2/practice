    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Growth Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Growth Coin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  growth-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Growth in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an growthtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 GRW, 0.1 GRW, 1 GRW and 10 GRW -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://growthcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://growthcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Growth Coin is shutting down...") + "<br /><br />" +
