...
{
    if(fLiteMode) return; // ignore all Growth related functionality
...
/*
    ...
    allow endless transaction that would bloat Growth and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("growth-privatesend");
